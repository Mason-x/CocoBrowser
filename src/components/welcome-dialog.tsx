...
export function WelcomeDialog({
  ...
  const advanceToSetup = onComplete;
  ...
  // Never start a legacy/commercial browser download during onboarding.
  const setup = useBrowserSetup("wayfern", false);
