              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2 rounded-md border p-3">
                  ...
                  <div className="grid grid-cols-[auto_1fr] gap-x-3 gap-y-1.5 text-sm">
                    ...
                    {editingExtension.manifest_version && (
                      <>
                        <span className="text-muted-foreground">
                          {t("extensions.manifestVersion")}
                        </span>
                        <span>MV{editingExtension.manifest_version}</span>
                      </>
                    )}
                    {editingExtension.content_sha256 && (
                      <>
                        <span className="text-muted-foreground">
                          {t("extensions.sha256")}
                        </span>
                    ...
                    <span className="break-words text-xs">
                      {editingExtension.permissions.length > 0
                        ? editingExtension.permissions.join(", ")
                        : t("extensions.none")}
                    </span>
                    <span className="text-muted-foreground">
                      {t("extensions.hostPermissions")}
                    </span>
                    <span className="break-all text-xs">
                      {editingExtension.host_permissions.length > 0
                        ? editingExtension.host_permissions.join(", ")
                        : t("extensions.none")}
                    </span>
