#![allow(dead_code)] // Legacy downloader internals remain covered by tests but are not callable.
...
pub async fn download_browser(
  ...
  Err(format!(
    "Legacy browser downloader is disabled for {browser_str} {version}; use the audited kernel installer"
  ))
}
