#![allow(dead_code)] // Legacy archive formats remain available to migration tests.
...
impl Extractor {
  ...
  pub async fn extract_dmg(
    ...
    // Management TCC notification ("Coco.app was prevented from modifying
    ...
    // prompt ("Coco.app was prevented from modifying apps on your Mac"),
